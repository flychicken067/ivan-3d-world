...
export const ZONES = [
  { code: '01', name: 'WELCOME', label: 'Welcome', position: { x: 0, z: -80 }, radius: 15,
  ...
  { code: '02', name: 'PROJECTS', label: 'Projects', position: { x: -50, z: -30 }, radius: 18,
  ...
  { code: '03', name: 'SOULPRINT', label: 'Soulprint', position: { x: 50, z: -30 }, radius: 15,
  ...
  { code: '04', name: 'THEATER', label: 'Theater', position: { x: 0, z: 10 }, radius: 15,
  ...
  { code: '05', name: 'LIBRARY', label: 'Library', position: { x: -50, z: 50 }, radius: 15,
  ...
  { code: '06', name: 'SOCIAL', label: 'Social', position: { x: 50, z: 50 }, radius: 15,
  ...
  { code: '07', name: 'HIRE', label: 'Hire', position: { x: 0, z: 85 }, radius: 15,
...
export const CAMERA = { fov: 60, near: 0.1, far: 500, startPosition: { x: 0, y: 2, z: -90 }, moveSpeed: 0.12, height: 2 };
